...
preSent = Dense(400,activation=swish)(preSent)
preSent = Dropout(0.4)(preSent)
preSent = Dense(400,activation=swish)(preSent)
preSent = Dropout(0.5)(preSent)
...
posSent = Dense(400,activation=swish)(posSent)
posSent = Dropout(0.4)(posSent)
posSent = Dense(400,activation=swish)(posSent)
posSent = Dropout(0.5)(posSent)
...
for i in range(0,20):
    ...
    for epoch in range(epochs):
        ...
        for j in range(transferNum):
          false_pre_tuple += (np.roll(train_pre,roll_sample[j],axis=0),)
