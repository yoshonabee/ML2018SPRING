...
preSent = Bidirectional(GRU(128,activation=ht,dropout=0.2, return_sequences=True))(em1)
preSent = Bidirectional(GRU(64,activation=ht,dropout=0.2))(preSent)
preSent = BatchNormalization()(preSent)
preSent = Dense(256,activation=swish)(preSent)
preSent = Dense(256,activation=swish)(preSent)
...
posSent = Bidirectional(GRU(128,activation=ht,dropout=0.2, return_sequences = True))(em2)
posSent = Bidirectional(GRU(64,activation=ht,dropout=0.2))(posSent)
posSent = BatchNormalization()(posSent)
posSent = Dense(256,activation=swish)(posSent)
posSent = Dense(256,activation=swish)(posSent)
